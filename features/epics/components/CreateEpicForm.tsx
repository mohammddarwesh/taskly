  ...
  return (
    <div className="w-full max-w-3xl bg-white rounded-lg shadow-[0px_24px_48px_-12px_rgba(4,27,60,0.06)] border border-[rgba(195,198,214,0.1)]">
      ...
      <div className="px-8 pt-8 pb-6 border-b border-[rgba(195,198,214,0.1)]">
        <h1 className="text-4xl font-bold tracking-[-0.9px] text-[#041B3C]">Create New Epic</h1>
      ...
      <form onSubmit={onSubmit} className="p-8 space-y-8">
        {/* Title – row layout with label left */}
        <div className="grid grid-cols-[180px_1fr] items-start gap-4">
          <label htmlFor="title" className="font-bold text-[11px] leading-4 tracking-[0.55px] uppercase text-[#434654] pt-2">
            Title *
          </label>
          <div>
            <Input
        ...
        <div className="grid grid-cols-[180px_1fr] items-start gap-4">
          <div className="flex flex-col">
            <label htmlFor="description" className="font-bold text-[11px] leading-4 tracking-[0.55px] uppercase text-[#434654] pt-2">
              Description
            </label>
            <span className="text-[10px] text-[rgba(67,70,84,0.5)]">Optional</span>
          </div>
          <div>
            <Textarea
              id="description"
              ...
              label=""
            />
            <CharCounter current={descriptionValue.length} max={500} className="block text-right mt-1 text-[10px] text-[rgba(67,70,84,0.6)]" />
