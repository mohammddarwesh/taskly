...
export function EpicCard({ epic }: Props) {
  // Get initials for avatar background color
  ...
  return (
    <div className="flex flex-col justify-between p-4 bg-white border-l-4 border-[#004E32] shadow-[0px_1px_2px_rgba(0,0,0,0.05)] rounded-lg">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={`flex items-center justify-center w-10 h-10 rounded-xl ${avatarColor}`}>
          ...
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-normal text-[rgba(67,70,84,0.8)]">
                Created by <span className="font-medium text-[#041B3C]">{epic.created_by.name}</span>
              </span>
            </div>
