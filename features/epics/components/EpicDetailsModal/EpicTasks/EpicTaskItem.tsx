...
export function EpicTaskItem({ task }: { task: Task }) {
  ...
  return (
    <div
      className={cn(
        "flex items-center justify-between py-4 px-2 md:px-4",
        // Mobile: Card style (full border, rounded). Desktop: Row style (no border, just bottom divider)
    ...
    >
      ...
      <div className="flex items-center gap-4 flex-1 min-w-0">
        ...
        {/* ✅ Checkmark Icon - HIDDEN on Small Screens */}
        <div className="hidden md:flex shrink-0 w-6 h-6 rounded-full border-2 border-[#D7E2FF] items-center justify-center">
           <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#737685" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="flex flex-col gap-1 min-w-0">
          ...
          <div className="flex items-center gap-2">
            <Avatar name={assigneeName} size="sm" className="w-5 h-5 text-[10px]" />
      ...
      {/* Right Section: Due Date / Overdue */}
      {/* Mobile: flex-row items-center. Desktop: flex-col items-end */}
      <div className="flex flex-row md:flex-col items-center md:items-end gap-2 md:gap-0.5 flex-shrink-0 ml-4">
        
        {/* ✅ "DUE DATE" Label - HIDDEN on Small Screens */}
